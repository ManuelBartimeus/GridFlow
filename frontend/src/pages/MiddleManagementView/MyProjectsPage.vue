      ...
      <div :class="viewMode === 'grid' ? 'projects-section q-pa-md' : 'projects-section-list'">
        ...
        <div v-else class="projects-table-container">
          <div class="projects-table">
            ...
            <!-- Issue Project Row -->
            <div class="table-row issue-project-row" @click="issueProject">
              <div class="table-cell" style="flex: 1; justify-content: center;" colspan="9">
                <q-icon name="post_add" size="20px" color="grey-7" class="q-mr-sm" />
                <span class="issue-project-text">Issue Project - Create a new project</span>
              </div>
            </div>
...
.issue-project-card-list {
  min-height: auto;
  padding: 20px 24px;
}

.issue-project-card-list .issue-project-content {
  flex-direction: row;
  gap: 16px;
}

.issue-project-card-list .q-icon {
  margin-bottom: 0;
}

.issue-project-card-list .issue-project-title {
  text-align: left;
}

.issue-project-card-list .issue-project-subtitle {
  text-align: left;
}
